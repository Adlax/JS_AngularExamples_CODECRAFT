...
class ArtistVideoListComponent {
  private videos: any[];
...
class AlwaysAuthChildrenGuard implements CanActivateChild {
  canActivate(): boolean {
    console.log("Always Auth Children Guard");
    return true;
  }
}
...
class OnlyLoggedInUsersGuard implements CanActivate {
  ...
  canActivate(){
    ...
    if(this.userService.isLoggedIn()){
      ...
      window.alert("U don't have enough permissions to access this page");
      return false;
    }
  }
}
...
class UnsearchedTermGuard implements CanDeactivate<SearchComponent> {
  canDeactivate(component: SearchComponent,
    ...
    console.log("You entered no searched term");
    console.log(state.url);
    return component.canDeactivate() || window.confirm("T'es sur ma poule?");
  }
}
*/
