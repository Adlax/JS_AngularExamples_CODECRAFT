...
class FormAppComponent {
  ...
  constructor(fb: FormBuilder) {
    ...
    this.form.valueChanges
        .debounceTime(1000)
        //met un delay de 1s (en gros ca prend pas toutes les frappes de caracteres ici)
        .distinctUntilChanged()
        //cette fonction sort une obs dont les val sont les memes que l obs d entree, mais sans 2 valeurs consecutives egales
